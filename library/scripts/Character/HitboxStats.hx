// Hitbox stats
{
	//LIGHT ATTACKS
	jab1: {
		hitbox0: { damage: 11, angle: 35, baseKnockback: 75, knockbackGrowth: 80, hitstop: -1, selfHitstop: -1, limb:AttackLimb.HEAD },
		hitbox1: { damage: 11, angle: 35, baseKnockback: 75, knockbackGrowth: 80, hitstop: -1, selfHitstop: -1, limb:AttackLimb.HEAD }
	},
	dash_attack: {
